...
#[doc = "Field `PINP` reader - Protocol Interrupt Node Pointer"]
pub type PINP_R = crate::FieldReader;
#[doc = "Field `PINP` writer - Protocol Interrupt Node Pointer"]
...
impl R {
    ...
    #[doc = "Bits 16:18 - Protocol Interrupt Node Pointer"]
    #[inline(always)]
