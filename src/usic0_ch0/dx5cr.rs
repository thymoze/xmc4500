#[doc = "Register `DX5CR` reader"]
pub type R = crate::R<DX5CR_SPEC>;
#[doc = "Register `DX5CR` writer"]
pub type W = crate::W<DX5CR_SPEC>;
...
#[doc = "Input Control Register 5\n\nYou can [`read`](crate::Reg::read) this register and get [`dx5cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dx5cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DX5CR_SPEC;
impl crate::RegisterSpec for DX5CR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dx5cr::R`](R) reader structure"]
impl crate::Readable for DX5CR_SPEC {}
