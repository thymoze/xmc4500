#[doc = "Register `DX4CR` reader"]
pub type R = crate::R<DX4CR_SPEC>;
#[doc = "Register `DX4CR` writer"]
pub type W = crate::W<DX4CR_SPEC>;
...
#[doc = "Input Control Register 4\n\nYou can [`read`](crate::Reg::read) this register and get [`dx4cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dx4cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DX4CR_SPEC;
impl crate::RegisterSpec for DX4CR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dx4cr::R`](R) reader structure"]
impl crate::Readable for DX4CR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`dx4cr::W`](W) writer structure"]
impl crate::Writable for DX4CR_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DX4CR to value 0"]
impl crate::Resettable for DX4CR_SPEC {}
