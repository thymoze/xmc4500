...
pub enum TE_A {
    ...
    VALUE1 = 0,
    #[doc = "1: The trigger event has been detected (or the trigger mechanism is switched off) and a transmission of the data word in TBUF can be started."]
    VALUE2 = 1,
}
...
impl TE_R {
    ...
    #[doc = "The trigger event has been detected (or the trigger mechanism is switched off) and a transmission of the data word in TBUF can be started."]
    #[inline(always)]
    pub fn is_value2(&self) -> bool {
        *self == TE_A::VALUE2
    }
