...
impl PD12_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> PD12_A {
        match self.bits {
            2 => PD12_A::SD_SOE,
            3 => PD12_A::SD_SLE,
            4 => PD12_A::MD,
...
pub type PD12_W<'a, REG> = crate::FieldWriter<'a, REG, 3, PD12_A, crate::Safe>;
...
impl PD13_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> PD13_A {
        match self.bits {
            2 => PD13_A::SD_SOE,
            3 => PD13_A::SD_SLE,
            4 => PD13_A::MD,
...
pub type PD13_W<'a, REG> = crate::FieldWriter<'a, REG, 3, PD13_A, crate::Safe>;
