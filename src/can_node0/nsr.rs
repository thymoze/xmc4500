...
pub enum LOE_A {
    ...
    VALUE1 = 0,
    #[doc = "1: A List Object Error has been detected during message acceptance filtering. A message object with wrong LIST index entry in the Message Object Control Register has been detected."]
    VALUE2 = 1,
}
...
impl LOE_R {
    ...
    #[doc = "A List Object Error has been detected during message acceptance filtering. A message object with wrong LIST index entry in the Message Object Control Register has been detected."]
    #[inline(always)]
    pub fn is_value2(&self) -> bool {
        *self == LOE_A::VALUE2
    }
...
#[doc = "Suspend Acknowledge\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SUSACK_A {
    #[doc = "0: The CAN node is not in Suspend Mode or a suspend request is pending, but the CAN node has not yet reached bus-idle or bus-off."]
    VALUE1 = 0,
    #[doc = "1: The CAN node is in Suspend Mode: The CAN node is inactive (bit NCR.INIT internally forced to 1) due to an OCDS suspend request."]
    VALUE2 = 1,
}
impl From<SUSACK_A> for bool {
    #[inline(always)]
    fn from(variant: SUSACK_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `SUSACK` reader - Suspend Acknowledge"]
pub type SUSACK_R = crate::BitReader<SUSACK_A>;
impl SUSACK_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> SUSACK_A {
        match self.bits {
            false => SUSACK_A::VALUE1,
            true => SUSACK_A::VALUE2,
        }
    }
    #[doc = "The CAN node is not in Suspend Mode or a suspend request is pending, but the CAN node has not yet reached bus-idle or bus-off."]
    #[inline(always)]
    pub fn is_value1(&self) -> bool {
        *self == SUSACK_A::VALUE1
    }
    #[doc = "The CAN node is in Suspend Mode: The CAN node is inactive (bit NCR.INIT internally forced to 1) due to an OCDS suspend request."]
    #[inline(always)]
    pub fn is_value2(&self) -> bool {
        *self == SUSACK_A::VALUE2
    }
}
impl R {
