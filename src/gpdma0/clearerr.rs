...
impl W {
    ...
    #[inline(always)]
    pub fn ch4(&mut self) -> CH4_W<CLEARERR_SPEC> {
        CH4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Clear Interrupt Status and Raw Status for channel 5"]
    #[inline(always)]
    pub fn ch5(&mut self) -> CH5_W<CLEARERR_SPEC> {
        CH5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Clear Interrupt Status and Raw Status for channel 6"]
    #[inline(always)]
    pub fn ch6(&mut self) -> CH6_W<CLEARERR_SPEC> {
        CH6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Clear Interrupt Status and Raw Status for channel 7"]
    #[inline(always)]
    pub fn ch7(&mut self) -> CH7_W<CLEARERR_SPEC> {
        CH7_W::new(self, 7)
    }
}
#[doc = "IntErr Status\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`clearerr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
