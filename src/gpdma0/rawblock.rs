#[doc = "Register `RAWBLOCK` reader"]
pub type R = crate::R<RAWBLOCK_SPEC>;
#[doc = "Register `RAWBLOCK` writer"]
pub type W = crate::W<RAWBLOCK_SPEC>;
...
impl W {
    #[doc = "Bit 0 - Raw Interrupt Status for channel 0"]
    #[inline(always)]
    pub fn ch0(&mut self) -> CH0_W<RAWBLOCK_SPEC> {
        CH0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Raw Interrupt Status for channel 1"]
    #[inline(always)]
    pub fn ch1(&mut self) -> CH1_W<RAWBLOCK_SPEC> {
        CH1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Raw Interrupt Status for channel 2"]
    #[inline(always)]
    pub fn ch2(&mut self) -> CH2_W<RAWBLOCK_SPEC> {
        CH2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Raw Interrupt Status for channel 3"]
    #[inline(always)]
    pub fn ch3(&mut self) -> CH3_W<RAWBLOCK_SPEC> {
        CH3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Raw Interrupt Status for channel 4"]
    #[inline(always)]
    pub fn ch4(&mut self) -> CH4_W<RAWBLOCK_SPEC> {
        CH4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Raw Interrupt Status for channel 5"]
    #[inline(always)]
    pub fn ch5(&mut self) -> CH5_W<RAWBLOCK_SPEC> {
        CH5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Raw Interrupt Status for channel 6"]
    #[inline(always)]
    pub fn ch6(&mut self) -> CH6_W<RAWBLOCK_SPEC> {
        CH6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Raw Interrupt Status for channel 7"]
    #[inline(always)]
    pub fn ch7(&mut self) -> CH7_W<RAWBLOCK_SPEC> {
        CH7_W::new(self, 7)
    }
}
#[doc = "Raw IntBlock Status\n\nYou can [`read`](crate::Reg::read) this register and get [`rawblock::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rawblock::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RAWBLOCK_SPEC;
impl crate::RegisterSpec for RAWBLOCK_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rawblock::R`](R) reader structure"]
impl crate::Readable for RAWBLOCK_SPEC {}
#[doc = "`write(|w| ..)` method takes [`rawblock::W`](W) writer structure"]
impl crate::Writable for RAWBLOCK_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RAWBLOCK to value 0"]
impl crate::Resettable for RAWBLOCK_SPEC {}
