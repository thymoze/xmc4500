...
pub type R = crate::R<MASKSRCTRAN_SPEC>;
#[doc = "Register `MASKSRCTRAN` writer"]
pub type W = crate::W<MASKSRCTRAN_SPEC>;
...
impl W {
    ...
    #[doc = "Bit 4 - Mask bit for channel 4"]
    #[inline(always)]
    pub fn ch4(&mut self) -> CH4_W<MASKSRCTRAN_SPEC> {
        CH4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Mask bit for channel 5"]
    #[inline(always)]
    pub fn ch5(&mut self) -> CH5_W<MASKSRCTRAN_SPEC> {
        CH5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Mask bit for channel 6"]
    #[inline(always)]
    pub fn ch6(&mut self) -> CH6_W<MASKSRCTRAN_SPEC> {
        CH6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Mask bit for channel 7"]
    #[inline(always)]
    pub fn ch7(&mut self) -> CH7_W<MASKSRCTRAN_SPEC> {
        CH7_W::new(self, 7)
    }
    ...
    #[inline(always)]
    pub fn we_ch4(&mut self) -> WE_CH4_W<MASKSRCTRAN_SPEC> {
        WE_CH4_W::new(self, 12)
    }
    #[doc = "Bit 13 - Write enable for mask bit of channel 5"]
    #[inline(always)]
    pub fn we_ch5(&mut self) -> WE_CH5_W<MASKSRCTRAN_SPEC> {
        WE_CH5_W::new(self, 13)
    }
    #[doc = "Bit 14 - Write enable for mask bit of channel 6"]
    #[inline(always)]
    pub fn we_ch6(&mut self) -> WE_CH6_W<MASKSRCTRAN_SPEC> {
        WE_CH6_W::new(self, 14)
    }
    #[doc = "Bit 15 - Write enable for mask bit of channel 7"]
    #[inline(always)]
    pub fn we_ch7(&mut self) -> WE_CH7_W<MASKSRCTRAN_SPEC> {
        WE_CH7_W::new(self, 15)
    }
}
#[doc = "Mask for Raw IntSrcTran Status\n\nYou can [`read`](crate::Reg::read) this register and get [`masksrctran::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`masksrctran::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
