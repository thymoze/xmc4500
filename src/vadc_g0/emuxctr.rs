...
pub type EMUXCH_R = crate::FieldReader;
#[doc = "Field `EMUXCH` writer - External Multiplexer Channel Select"]
pub type EMUXCH_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
pub enum EMXWC_A {
    ...
    VALUE1 = 0,
    #[doc = "1: Bitfields EMXMODE, EMXCOD, EMXST can be written"]
    VALUE2 = 1,
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[doc = "Bitfields EMXMODE, EMXCOD, EMXST can be written"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut crate::W<REG> {
...
impl R {
    ...
    #[doc = "Bits 16:20 - External Multiplexer Channel Select"]
    #[inline(always)]
    pub fn emuxch(&self) -> EMUXCH_R {
        EMUXCH_R::new(((self.bits >> 16) & 0x1f) as u8)
    }
