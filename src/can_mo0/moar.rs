...
#[repr(u8)]
pub enum PRI_A {
    #[doc = "0: Applicable only if TTCAN is available."]
    VALUE1 = 0,
...
impl PRI_R {
    ...
    #[doc = "Applicable only if TTCAN is available."]
    #[inline(always)]
    pub fn is_value1(&self) -> bool {
        *self == PRI_A::VALUE1
    }
...
pub type PRI_W<'a, REG> = crate::FieldWriter<'a, REG, 2, PRI_A, crate::Safe>;
