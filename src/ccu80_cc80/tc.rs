...
impl STOS_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<STOS_A> {
        match self.bits {
            0 => Some(STOS_A::VALUE1),
            1 => Some(STOS_A::VALUE2),
            2 => Some(STOS_A::VALUE3),
            _ => None,
        }
    }
...
pub type STOS_W<'a, REG> = crate::FieldWriter<'a, REG, 2, STOS_A>;
