...
pub type PD8_W<'a, REG> = crate::FieldWriter<'a, REG, 3, PD8_A, crate::Safe>;
...
impl PD9_R {
    ...
    #[inline(always)]
    pub fn is_sd_soe_alt(&self) -> bool {
        *self == PD9_A::SD_SOE_ALT
    }
    #[doc = "A1+ strong driver, slow edge (alternate value)"]
    #[inline(always)]
    pub fn is_sd_sle_alt(&self) -> bool {
        *self == PD9_A::SD_SLE_ALT
    }
    #[doc = "A1+ medium driver (alternate value)"]
    #[inline(always)]
    pub fn is_md_alt(&self) -> bool {
...
pub type PD9_W<'a, REG> = crate::FieldWriter<'a, REG, 3, PD9_A, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn sd_soe_alt(self) -> &'a mut crate::W<REG> {
        self.variant(PD9_A::SD_SOE_ALT)
    }
    #[doc = "A1+ strong driver, slow edge (alternate value)"]
    #[inline(always)]
    pub fn sd_sle_alt(self) -> &'a mut crate::W<REG> {
        self.variant(PD9_A::SD_SLE_ALT)
    }
    #[doc = "A1+ medium driver (alternate value)"]
    #[inline(always)]
    pub fn md_alt(self) -> &'a mut crate::W<REG> {
        self.variant(PD9_A::MD_ALT)
    }
    #[doc = "A1+ weak driver (alternate value)"]
    #[inline(always)]
    pub fn wd_alt(self) -> &'a mut crate::W<REG> {
        self.variant(PD9_A::WD_ALT)
    }
}
...
pub type PD14_W<'a, REG> = crate::FieldWriter<'a, REG, 3, PD14_A, crate::Safe>;
...
pub type PD15_W<'a, REG> = crate::FieldWriter<'a, REG, 3, PD15_A, crate::Safe>;
