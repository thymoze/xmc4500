...
pub type R = crate::R<ADDRSEL0_SPEC>;
#[doc = "Register `ADDRSEL0` writer"]
pub type W = crate::W<ADDRSEL0_SPEC>;
...
impl W {
    #[doc = "Bit 0 - Memory Region Enable"]
    #[inline(always)]
    pub fn regenab(&mut self) -> REGENAB_W<ADDRSEL0_SPEC> {
        REGENAB_W::new(self, 0)
    }
    #[doc = "Bit 1 - Alternate Region Enable"]
    #[inline(always)]
    pub fn altenab(&mut self) -> ALTENAB_W<ADDRSEL0_SPEC> {
        ALTENAB_W::new(self, 1)
    }
    #[doc = "Bit 2 - Memory Region Write Protect"]
    #[inline(always)]
    pub fn wprot(&mut self) -> WPROT_W<ADDRSEL0_SPEC> {
        WPROT_W::new(self, 2)
    }
}
#[doc = "EBU Address Select Register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`addrsel0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`addrsel0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
