...
pub type R = crate::R<BUSWCON1_SPEC>;
#[doc = "Register `BUSWCON1` writer"]
pub type W = crate::W<BUSWCON1_SPEC>;
...
#[doc = "EBU Bus Write Configuration Register\n\nYou can [`read`](crate::Reg::read) this register and get [`buswcon1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`buswcon1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
