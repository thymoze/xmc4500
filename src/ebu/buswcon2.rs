#[doc = "Register `BUSWCON2` reader"]
pub type R = crate::R<BUSWCON2_SPEC>;
#[doc = "Register `BUSWCON2` writer"]
pub type W = crate::W<BUSWCON2_SPEC>;
...
#[doc = "EBU Bus Write Configuration Register\n\nYou can [`read`](crate::Reg::read) this register and get [`buswcon2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`buswcon2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BUSWCON2_SPEC;
impl crate::RegisterSpec for BUSWCON2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`buswcon2::R`](R) reader structure"]
impl crate::Readable for BUSWCON2_SPEC {}
