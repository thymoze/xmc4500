...
pub type PACS_W<'a, REG> = crate::FieldWriter<'a, REG, 2, PACS_A, crate::Safe>;
...
pub type PISEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2, PISEL_A, crate::Safe>;
...
pub type PCDS_W<'a, REG> = crate::FieldWriter<'a, REG, 2, PCDS_A, crate::Safe>;
...
#[doc = "Parity Checker Configuration\n\nYou can [`read`](crate::Reg::read) this register and get [`gpchk::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpchk::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
