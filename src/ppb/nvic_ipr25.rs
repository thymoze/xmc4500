...
impl W {
    #[doc = "Bits 0:7 - Priority value 0"]
    #[inline(always)]
    pub fn pri_0(&mut self) -> PRI_0_W<NVIC_IPR25_SPEC> {
        PRI_0_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Priority value 1"]
    #[inline(always)]
    pub fn pri_1(&mut self) -> PRI_1_W<NVIC_IPR25_SPEC> {
        PRI_1_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Priority value 2"]
    #[inline(always)]
    pub fn pri_2(&mut self) -> PRI_2_W<NVIC_IPR25_SPEC> {
        PRI_2_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Priority value 3"]
    #[inline(always)]
    pub fn pri_3(&mut self) -> PRI_3_W<NVIC_IPR25_SPEC> {
        PRI_3_W::new(self, 24)
    }
}
#[doc = "Interrupt Priority Register 25\n\nYou can [`read`](crate::Reg::read) this register and get [`nvic_ipr25::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`nvic_ipr25::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets NVIC_IPR25 to value 0"]
impl crate::Resettable for NVIC_IPR25_SPEC {}
