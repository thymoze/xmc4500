#[doc = "Register `NVIC_IPR10` reader"]
pub type R = crate::R<NVIC_IPR10_SPEC>;
#[doc = "Register `NVIC_IPR10` writer"]
pub type W = crate::W<NVIC_IPR10_SPEC>;
...
impl W {
    #[doc = "Bits 0:7 - Priority value 0"]
    #[inline(always)]
    pub fn pri_0(&mut self) -> PRI_0_W<NVIC_IPR10_SPEC> {
        PRI_0_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Priority value 1"]
    #[inline(always)]
    pub fn pri_1(&mut self) -> PRI_1_W<NVIC_IPR10_SPEC> {
        PRI_1_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Priority value 2"]
    #[inline(always)]
    pub fn pri_2(&mut self) -> PRI_2_W<NVIC_IPR10_SPEC> {
        PRI_2_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Priority value 3"]
    #[inline(always)]
    pub fn pri_3(&mut self) -> PRI_3_W<NVIC_IPR10_SPEC> {
        PRI_3_W::new(self, 24)
    }
}
#[doc = "Interrupt Priority Register 10\n\nYou can [`read`](crate::Reg::read) this register and get [`nvic_ipr10::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`nvic_ipr10::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct NVIC_IPR10_SPEC;
impl crate::RegisterSpec for NVIC_IPR10_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`nvic_ipr10::R`](R) reader structure"]
impl crate::Readable for NVIC_IPR10_SPEC {}
#[doc = "`write(|w| ..)` method takes [`nvic_ipr10::W`](W) writer structure"]
impl crate::Writable for NVIC_IPR10_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets NVIC_IPR10 to value 0"]
impl crate::Resettable for NVIC_IPR10_SPEC {}
