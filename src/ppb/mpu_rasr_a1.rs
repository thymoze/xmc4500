...
pub type R = crate::R<MPU_RASR_A1_SPEC>;
#[doc = "Register `MPU_RASR_A1` writer"]
pub type W = crate::W<MPU_RASR_A1_SPEC>;
...
impl W {
    #[doc = "Bit 0 - Region enable bit."]
    #[inline(always)]
    pub fn enable(&mut self) -> ENABLE_W<MPU_RASR_A1_SPEC> {
        ENABLE_W::new(self, 0)
    }
    #[doc = "Bits 1:5 - MPU protection region size"]
    #[inline(always)]
    pub fn size(&mut self) -> SIZE_W<MPU_RASR_A1_SPEC> {
        SIZE_W::new(self, 1)
    }
    #[doc = "Bits 8:15 - Subregion disable bits"]
    #[inline(always)]
    pub fn srd(&mut self) -> SRD_W<MPU_RASR_A1_SPEC> {
        SRD_W::new(self, 8)
    }
    #[doc = "Bit 16 - Memory access attribute"]
    #[inline(always)]
    pub fn b(&mut self) -> B_W<MPU_RASR_A1_SPEC> {
        B_W::new(self, 16)
    }
    #[doc = "Bit 17 - Memory access attribute"]
    #[inline(always)]
    pub fn c(&mut self) -> C_W<MPU_RASR_A1_SPEC> {
        C_W::new(self, 17)
    }
    #[doc = "Bit 18 - Shareable bit"]
    #[inline(always)]
    pub fn s(&mut self) -> S_W<MPU_RASR_A1_SPEC> {
        S_W::new(self, 18)
    }
    #[doc = "Bits 19:21 - Memory access attribute"]
    #[inline(always)]
    pub fn tex(&mut self) -> TEX_W<MPU_RASR_A1_SPEC> {
        TEX_W::new(self, 19)
    }
    #[doc = "Bits 24:26 - Access permission field"]
    #[inline(always)]
    pub fn ap(&mut self) -> AP_W<MPU_RASR_A1_SPEC> {
        AP_W::new(self, 24)
    }
    #[doc = "Bit 28 - Instruction access disable bit"]
    #[inline(always)]
    pub fn xn(&mut self) -> XN_W<MPU_RASR_A1_SPEC> {
        XN_W::new(self, 28)
    }
}
#[doc = "MPU Region Attribute and Size Register A1\n\nYou can [`read`](crate::Reg::read) this register and get [`mpu_rasr_a1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpu_rasr_a1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
