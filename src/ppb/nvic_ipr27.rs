#[doc = "Register `NVIC_IPR27` reader"]
pub type R = crate::R<NVIC_IPR27_SPEC>;
#[doc = "Register `NVIC_IPR27` writer"]
pub type W = crate::W<NVIC_IPR27_SPEC>;
...
#[doc = "Interrupt Priority Register 27\n\nYou can [`read`](crate::Reg::read) this register and get [`nvic_ipr27::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`nvic_ipr27::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct NVIC_IPR27_SPEC;
impl crate::RegisterSpec for NVIC_IPR27_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`nvic_ipr27::R`](R) reader structure"]
impl crate::Readable for NVIC_IPR27_SPEC {}
#[doc = "`write(|w| ..)` method takes [`nvic_ipr27::W`](W) writer structure"]
impl crate::Writable for NVIC_IPR27_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets NVIC_IPR27 to value 0"]
impl crate::Resettable for NVIC_IPR27_SPEC {}
