#[doc = "Register `NVIC_IPR17` reader"]
pub type R = crate::R<NVIC_IPR17_SPEC>;
#[doc = "Register `NVIC_IPR17` writer"]
pub type W = crate::W<NVIC_IPR17_SPEC>;
...
#[doc = "Interrupt Priority Register 17\n\nYou can [`read`](crate::Reg::read) this register and get [`nvic_ipr17::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`nvic_ipr17::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct NVIC_IPR17_SPEC;
impl crate::RegisterSpec for NVIC_IPR17_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`nvic_ipr17::R`](R) reader structure"]
impl crate::Readable for NVIC_IPR17_SPEC {}
#[doc = "`write(|w| ..)` method takes [`nvic_ipr17::W`](W) writer structure"]
impl crate::Writable for NVIC_IPR17_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets NVIC_IPR17 to value 0"]
impl crate::Resettable for NVIC_IPR17_SPEC {}
