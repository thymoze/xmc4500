#[doc = "Register `NVIC_ICER3` reader"]
pub type R = crate::R<NVIC_ICER3_SPEC>;
#[doc = "Register `NVIC_ICER3` writer"]
pub type W = crate::W<NVIC_ICER3_SPEC>;
...
#[doc = "Interrupt Clear-enable Register 3\n\nYou can [`read`](crate::Reg::read) this register and get [`nvic_icer3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`nvic_icer3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct NVIC_ICER3_SPEC;
impl crate::RegisterSpec for NVIC_ICER3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`nvic_icer3::R`](R) reader structure"]
impl crate::Readable for NVIC_ICER3_SPEC {}
