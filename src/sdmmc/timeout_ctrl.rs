...
impl crate::IsEnum for DAT_TIMEOUT_CNT_VAL_A {}
...
#[doc = "Timeout Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`timeout_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timeout_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
